...
_a = Tables;
Tables.tableAvailable = (tableName, dbName) => __awaiter(void 0, void 0, void 0, function* () {
    const projectRoot = process.cwd();
    const databaseFolder = (0, path_1.join)(projectRoot, 'Database', dbName, tableName);
    try {
        // Check if the database folder exists
        yield fs_1.promises.access(databaseFolder);
